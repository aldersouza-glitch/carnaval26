...
// Dados detalhados de 'OUTROS' baseados 100% na planilha oficial da imagem
export const OTHERS_OBSERVATIONS: OtherObservation[] = [
  { category: 'Jurídico', observation: 'PRESO JUDICIAL', opm: 'AJUDANCIA', count: 1 },
  { category: 'Operacional', observation: 'P2', opm: 'BPA', count: 4 },
  ...
  { category: 'Social/Saúde', observation: 'CURADOR DE DEPENDENTE PCD (PORTARIA N°...)', opm: 'CFAP', count: 1 },
  { category: 'Disposição', observation: 'SENASP', opm: 'CIA', count: 1 },
  { category: 'Operacional', observation: 'RPMON', opm: 'CIA', count: 1 },
  { category: 'Jurídico', observation: 'À DISPOSIÇÃO DA 13 VARA CRIMINAL DA CAPITAL', opm: 'CORREG', count: 2 },
  { category: 'Disposição', observation: 'CORREGEDORIA', opm: 'CORREG', count: 1 },
  { category: 'Função/Cargo', observation: 'COMANDANTE', opm: 'CPE', count: 1 },
  { category: 'Jurídico', observation: 'PROCESSO SEI N° E:01206.0000005569/2024', opm: 'DEIP', count: 1 },
  { category: 'Função/Cargo', observation: 'MOTORISTA DO COORDENADOR DE LOGÍSTICA', opm: 'DLOG', count: 1 },
  ...
  { category: 'Social/Saúde', observation: 'CUIDADORA DA MÃE (E:01206.0000030422/2024)', opm: 'DP', count: 1 },
  { category: 'Jurídico', observation: 'A DISPOSIÇÃO DO MP', opm: 'DP', count: 1 },
